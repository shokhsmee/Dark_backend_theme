...
URLs in static/src/scss/backend_theme.scss.
    ...
    'assets': {
        'web._assets_primary_variables': [
            'Dark_backend_theme/static/src/scss/primary_variables.scss',
        ],
        'web.assets_backend': [
            'Dark_backend_theme/static/src/js/theme_config_service.js',
            'Dark_backend_theme/static/src/xml/menu_panels.xml',
            'Dark_backend_theme/static/src/xml/nav_bar_panel.xml',
            'Dark_backend_theme/static/src/xml/home_menus.xml',
            'Dark_backend_theme/static/src/xml/side_bar_panel.xml',
            'Dark_backend_theme/static/src/scss/backend_theme.scss',
            'Dark_backend_theme/static/src/js/home_menus.js',
            'Dark_backend_theme/static/src/js/search_apps.js',
        ],
    },
    'installable': True,
    'application': False,
